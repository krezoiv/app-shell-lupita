...
export class PurchasesComponent implements OnInit {
  ...
  releaseAmountGallons() {
    this._fuelInventoryService.updateAvailableGallonsPurchase(this.purchaseForm.value)
      .subscribe(data => {
        Swal.fire({
          position: 'top-end',
          icon: 'success',
          title: 'Combustibles cargadas a los tanques',
